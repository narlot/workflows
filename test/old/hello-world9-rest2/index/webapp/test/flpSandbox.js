		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Inbox",
									"targetURL": "#appindexindex-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appindexindex-display": {
								"semanticObject": "appindexindex",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.index.index",
									"url": sap.ui.require.toUrl("app/index/index")
								}
							}
						}
					}
