		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nsmoduleeight-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsmoduleeight-display": {
								"semanticObject": "nsmoduleeight",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.moduleeight",
									"url": sap.ui.require.toUrl("ns/moduleeight")
								}
							}
						}
					}
