		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Inbox App",
									"targetURL": "#vappmoduleappmoduleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vappmoduleappmoduleapp-display": {
								"semanticObject": "vappmoduleappmoduleapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vapp.moduleapp.moduleapp",
									"url": sap.ui.require.toUrl("vapp/moduleapp/moduleapp")
								}
							}
						}
					}
