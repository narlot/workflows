		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#appnorthwindnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appnorthwindnorthwind-display": {
								"semanticObject": "appnorthwindnorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.northwind.northwind",
									"url": sap.ui.require.toUrl("app/northwind/northwind")
								}
							}
						}
					}
